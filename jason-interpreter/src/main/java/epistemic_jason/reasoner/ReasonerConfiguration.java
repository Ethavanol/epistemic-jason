...
public class ReasonerConfiguration {
    ...
    private static final String API_REPLACE_PROPS = "/api/replace-props";
    ...
    String getReplacePropsEndpoint() {
        return fullHost + API_REPLACE_PROPS;
    }
