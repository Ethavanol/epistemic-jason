...
//        var can = beliefBase.getCandidateBeliefs(t, new Unifier());
    ...
    public static void main(String[] args) {
        try {
            ...
            AgentEpistemic a = new AgentEpistemic();
            a.setBB(defaultBeliefBase);

            a.setTS(new TransitionSystemEpistemic(a, new Circumstance(), new Settings(), new AgArchEpistemic() {
                @Override
...
//            a.getTS().getAgArch().isRunning();
            ...
            a.getEpistemicExtension().modelCreateSem("agent");

            var cl = new BaseLiteral(ASSyntax.parseLiteral("~obs(down)"));
            var rew = cl.rewriteConsequences(a, new Unifier());
...
//            var newForm = r.rewrite(form);
            ...
            EpistemicParser p = new EpistemicParser();
            var iter = p.parseFormulaToEpistemicFormula(form, false).rewriteConsequences(a, new Unifier());
            ...
            while (iter != null && iter.hasNext()) {
                ...
                System.out.println(result + " Prop: " + val.getKey().simplify().toPropFormula(null));
                System.out.println("======");
            }
...
//            System.out.println("Consequences: " + r.rewrite(form));
    ...
    private static void propRules(Literal lit, DefaultBeliefBase defaultBeliefBase, AgentEpistemic a) throws Exception {
        ...
        while (res != null && res.hasNext()) {
            ...
            EpistemicFormula body = p.parseFormulaToEpistemicFormula(r.getBody(), false);
            var iter = body.rewriteConsequences(a, new Unifier());
            ...
            while (iter != null && iter.hasNext()) {
                ...
                System.out.println("Prop: " + val.getFormula().simplify().toPropFormula(null) + " implies " + r.headCApply(val.getUnifier()));
                System.out.println("======");
            }
