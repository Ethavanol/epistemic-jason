...
=== To install epistemic-jason in MavenLocal (needed to run the localization-demo)

What you want to do here, is to install this jason implementation in your maven local, so you can use it as a dependency then.0
...
To check that it has been installed correctly, you can verify that the folder org/jason/jason/epistemic-3.1 exists in your local maven repo.
