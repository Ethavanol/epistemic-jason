...
Down here in the "For Jason users" section is the documentation from the basic Jason repo.
If you want to install this repo as a version of Jason, you can refer to it.

=== Install epistemic-jason in MavenLocal (needed to run the localization-demo)
